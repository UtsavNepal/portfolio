...
const Skill = () => {
  const skillsData = {
    skills: [
      {
        "Backend Development": ".NET (C#), Django, Next.js,Nest js, Fastapi,Express.js",
        "Frontend Development": "React, Tailwind, TypeScript, Next Js, Expo go, Nest js, JavaScript, HTML, CSS, Bootstrap",
